<div class="row app-menu">
    <div class="col-xl-3 col-md-2 col-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="190" height="80" viewBox="0 0 210 297"  id="svg3705">
            <text x="-111.205" y="266.452" fill="none" stroke="#000" stroke-width="5.94" font-family="monospace" font-size="202.72" font-weight="700" letter-spacing="0" style="line-height:1.25;-inkscape-font-specification:'monospace, Bold';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start" transform="matrix(.96208 -.0013 .00255 1.03941 0 0)" word-spacing="0">
                <tspan x="-111.205" y="266.452" font-weight="400" style="-inkscape-font-specification:monospace;font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start">C</tspan>
            </text>
    ...
    <div class="col-xl-9 col-md-10 col-12">
        <div class="row third-spc-menu justify-content-end">
            <nav class="nav nav-pills nav-fill">
                <a class="nav-item nav-link" href="./home.php">H . O . M . E</a>
                <a class="nav-item nav-link" href="./photos.php">P . H . O . T . O . S</a>
                <a class="nav-item nav-link" href="./about.php">A . B . O . U . T</a>
                <a class="nav-item nav-link" href="./contact.php">C . O . N . T . A . C . T</a>
            </nav>
        </div>
    </div>
</div>
